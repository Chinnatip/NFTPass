  ...
  return  <div className="w-screen h-screen pt-8 relative overflow-y-scroll overflow-x-hidden " style={{ background: 'url("image/bg_blur.jpg")'}}>
    <div className="w-4/5 m-auto z-10">
      ...
      <div className="rounded-24 mb-20 px-12 py-16 border border-white shadow-nft" style={{background: '#ffffff8c'}}>
        ...
        <span className="bg-white shadow-nft rounded-full h-10 inline-flex px-1 pr-3 font-bold items-center">
          <img src="image/opensea_icon.png" className="h-8 inline mr-2"/> Opensea
        </span>
        <span className="ml-3 bg-white shadow-nft rounded-full h-10 inline-flex px-1 pr-3 font-bold items-center">
